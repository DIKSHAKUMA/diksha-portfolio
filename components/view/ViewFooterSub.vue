...
<template>
    <div class="archive-wrapper">
        <footer class="archive">
            <div class="archive__label action magnet" data-name="menu" data-text="Archive" data-color="#FFF">
...
.archive-wrapper {
    ...
    --dot-size: 2px;
    --dot-space: 50px;
    /* dont ask me how linear backgrounds work, but google provides, it is complex*/
    background:
