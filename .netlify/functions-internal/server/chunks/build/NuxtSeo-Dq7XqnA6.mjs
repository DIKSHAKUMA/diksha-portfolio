import { w as useOgImageRuntimeConfig, x as useSiteConfig, l as __nuxt_component_3$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const IconComponent = runtimeConfig.hasNuxtIcon ? __nuxt_component_3$1 : defineComponent({
      render() {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-og-image@5.1.13_@unhea_16a39fac7c5f1c4be68503e5dc0fa7a8/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const NuxtSeo = Object.assign(_sfc_main, { __name: "NuxtSeo" });

export { NuxtSeo as default };
//# sourceMappingURL=NuxtSeo-Dq7XqnA6.mjs.map
