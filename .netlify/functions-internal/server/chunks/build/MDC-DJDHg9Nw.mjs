...
import { ay as pascalCase, az as kebabCase, s as destr } from '../_/nitro.mjs';
import { ssrRenderSlot, ssrRenderComponent } from 'vue/server-renderer';
import { O as useAsyncData } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxtjs+mdc@0.17.4_magicast@0.5.3/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue");
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import('./index-DtXdPWXn.mjs').then((n) => n.i);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxtjs+mdc@0.17.4_magicast@0.5.3/node_modules/@nuxtjs/mdc/dist/runtime/components/MDC.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MDC = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _sfc_main
}, Symbol.toStringTag, { value: "Module" }));

export { MDC as M, TEXT_TAGS as T, htmlTags as a, nodeTextContent as b, flatUnwrap as c, isText as d, nodeChildren as e, find as f, html as h, isTag as i, normalize as n, svg as s, unwrap as u };
//# sourceMappingURL=MDC-DJDHg9Nw.mjs.map
