...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2026-06-08T20:11:03.160Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2026-06-08T20:11:03.160Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "62bef808-44e0-4cee-884c-a5a1462182fe",
  ...
  "public": {
    ...
    "socialShare": {
      "baseUrl": "https://thomasthorstensson.com",
      "styled": false,
      "label": true,
      "icon": true
    },
    ...
    "nuxt-robots": {
      ...
      "sitemap": [
        "https://thomasthorstensson.com/sitemap.xml",
        "/sitemap.xml"
      ],
      "header": true,
    ...
    "sitemaps": {
      "sitemap.xml": {
        ...
        "defaults": {
          "changefreq": "weekly",
          "priority": 0.5,
          "lastmod": "2026-06-08T20:10:46.314Z"
        },
        "include": [],
        "exclude": [
          "/_**",
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "description": "Creative developer and designer crafting digital experiences with modern web technologies.",
        "defaultLocale": "en"
      }
    ],
    "version": "3.2.21",
...
const _xIGZ1EUInXtqi56_lnbmT6ExiI9fHt4zqgBoyKOqnc = defineNitroPlugin(async (nitroApp) => {
...
const _CXn6gi03X6ZSyA6cvvzRXPSBOlhF073BPbvECu1UBg = defineNitroPlugin(async (nitroApp) => {
...
const _R0cxtecqM5gHJbPLklsX58KxnwzsBdZFFJ40L5knzc = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _OR9xaZ7IbU7HJ0Dip22hZp_W_zmqzWu5lVaE5SSfGO0 = (function(nitro) {
...
const plugins = [
  _xIGZ1EUInXtqi56_lnbmT6ExiI9fHt4zqgBoyKOqnc,
_CXn6gi03X6ZSyA6cvvzRXPSBOlhF073BPbvECu1UBg,
_R0cxtecqM5gHJbPLklsX58KxnwzsBdZFFJ40L5knzc,
_OR9xaZ7IbU7HJ0Dip22hZp_W_zmqzWu5lVaE5SSfGO0
];
...
const collections = {
  ...
  'line-md': () => import('./icons2.mjs').then(m => m.default),
  'mdi': () => import('./icons3.mjs').then(m => m.default),
  'weui': () => import('./icons4.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _HInS5r = defineCachedEventHandler(async (event) => {
...
const _i0ndNl = eventHandler(async (event) => {
...
const _qX5Qln = eventHandler(async (e) => {
...
const _FHIOrg = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _Wb9RsU = defineEventHandler(async (e) => {
...
const _CgNSCM = defineEventHandler(async (e) => {
...
const _b0Q7gb = defineEventHandler(sitemapXmlEventHandler);

const _nqA3W1 = defineEventHandler((e) => {
  const path = e.path;
...
const _cBSSwe = lazyEventHandler(() => {
...
const _lazy_uXDvlf = () => import('../routes/api/graphql.post.mjs');
const _lazy_tx_R_o = () => import('../routes/api/weather.mjs');
const _lazy_JINTMV = () => import('../routes/api/word-of-day.mjs');
const _lazy_Oh57pt = () => import('../routes/renderer.mjs');
const _lazy_IJhN6U = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_Tx0XX4 = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/graphql', handler: _lazy_uXDvlf, lazy: true, middleware: false, method: "post" },
  { route: '/api/weather', handler: _lazy_tx_R_o, lazy: true, middleware: false, method: undefined },
  { route: '/api/word-of-day', handler: _lazy_JINTMV, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Oh57pt, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _HInS5r, lazy: false, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _i0ndNl, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _qX5Qln, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _FHIOrg, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Wb9RsU, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _CgNSCM, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _b0Q7gb, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_IJhN6U, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_Tx0XX4, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_Tx0XX4, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _nqA3W1, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: handler, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _cBSSwe, lazy: false, middleware: false, method: undefined },
  { route: '/blog-post/**', handler: _lazy_Oh57pt, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Oh57pt, lazy: true, middleware: false, method: undefined }
];
...
export { headSymbol as $, replaceIslandTeleports as A, prefixStorage as B, useStorage as C, useNitroOrigin as D, emojiCache as E, useOgImageRuntimeConfig as F, fetchIsland as G, createHeadCore as H, normaliseFontInput as I, theme as J, withTrailingSlash as K, handleCacheHeaders as L, setHeaders as M, NUXT_PAYLOAD_INLINE as N, setHeader as O, hash$1 as P, parseURL as Q, setResponseHeader as R, proxyRequest as S, sendRedirect as T, resolveContext as U, H3Error as V, hasProtocol as W, withBase as X, useHead as Y, isScriptProtocol as Z, defu as _, useRuntimeConfig as a, parseQuery as a0, klona as a1, withQuery as a2, sanitizeStatusCode as a3, encodePath as a4, decodePath as a5, getContext as a6, defuFn as a7, withoutTrailingSlash as a8, $fetch$1 as a9, baseURL as aa, executeAsync as ab, titleCase as ac, camelCase as ad, toRouteMatcher as ae, createRouter$1 as af, withoutBase as ag, useSeoMeta as ah, stringifyQuery as ai, withLeadingSlash as aj, hasTrailingSlash as ak, getRequestHeader as al, isEqual as am, setCookie as an, getCookie as ao, deleteCookie as ap, resolveUnrefHeadInput as aq, decodeHtml as ar, logger$1 as as, toBase64Image as at, htmlDecodeQuotes as au, sendError as av, fontCache as aw, encodeParam as ax, pascalCase as ay, kebabCase as az, getResponseStatusText as b, createError$1 as c, defineEventHandler as d, getResponseStatus as e, appId as f, getRouteRulesForPath as g, defineRenderHandler as h, buildAssetsURL as i, joinHeaders as j, appTeleportTag as k, appTeleportAttrs as l, getQuery as m, normalizeCookieHeader as n, createSSRContext as o, publicAssetsURL as p, appHead as q, readBody as r, destr as s, setSSRError as t, useNitroApp as u, getRouteRules as v, payloadCache as w, joinURL as x, getRenderer as y, renderInlineStyles as z };
